...
<section id="shrink-text" class="section shrink-text">
  <div class="shrink-text__container">
    ...
    <p class="shrink-text__full">
      <?php echo $full ?>
      <a class="shrink-text__link" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M24 11.871l-5-4.871v3h-19v4h19v3z"/></svg> Minify</a>
    </p>
